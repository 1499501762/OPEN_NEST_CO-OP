...
public static class CoopLoc
{
    ...
    public static string RoomPassword => T("房间密码(可选)", "Room Password (optional)");
    public static string RoomPasswordPlaceholder => T("(留空=无密码)", "(empty = no password)");
    public static string PasswordRequired => T("该房间需要密码", "This room is password protected");
    public static string PasswordError => T("密码错误", "Wrong password");
    public static string Confirm => T("确定", "OK");
    public static string Cancel => T("取消", "Cancel");
    public static string VersionMismatch => T("模组版本不一致", "Mod version mismatch");
    public static string RejoinLast => T("重连上次房间", "Rejoin Last");
    public static string RoomPwd => T("房间密码", "Room Password");
    public static string PwdHas => T("有密码", "Password");
    public static string PwdNone => T("无", "None");
